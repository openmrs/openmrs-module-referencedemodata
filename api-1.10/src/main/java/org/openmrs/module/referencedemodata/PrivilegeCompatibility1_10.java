...
public class PrivilegeCompatibility1_10 implements PrivilegeCompatibility {

	@Override
	public String GET_PROVIDERS() {
		return PrivilegeConstants.VIEW_PROVIDERS;
	}

	@Override
	public String GET_PERSONS() {
		return PrivilegeConstants.VIEW_PERSONS;
	}
}